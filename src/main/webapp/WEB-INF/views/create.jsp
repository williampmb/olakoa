	...
	<body>	
		<div class="container" >
			...
			<div class="title">
				<div class="row">
					...
					<div class="col-md-2">
						<span>Welcome</span><span class="user">${user.username}</span>
					</div>
					<div class="col-md-1">
		...
		<div class="row head">
			...
			<div class="col-md-12">
						...
						<div class="col-md-12">
							<input type="text" name="name" class="name" placeholder="Enter name" required></br>
						</div>
							</br>
						<div class="col-md-12">
						...
						<div class="col-md-12">
							<textarea rows="8"  name="description" class="description" required > </textarea></br>
						</div>
						<div class="col-md-12">
							<label>Thumbnail</br></label>
						</div>
						<div class="col-md-12">
							<input type="url" name="thumbnail" class="thumb" placeholder="Thumbnail URL" required></br>
						</div>
						<div class="col-md-12">
							<label>Unit Price</br></label>
						</div>
						<div class="col-md-12">
							<input type="text" name="cost" class="cost" placeholder="Unit Price (cents)" required></br>
						</div>
						<div class="col-md-12">
							</br>
