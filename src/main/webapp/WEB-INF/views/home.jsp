...
<%@ page import="com.pmb.olakoa.users.User" %>
  ...
  <head>
	...
	<body>	
		<div class="container" >
			...
			<div class="row head">
				<h3>Olakoa</h3>
				<h4>Sales list  <a class="plus" href="/olakoa/home/drinks/create">+<a/></h4>
			</div>
			<br/>
			<br/>
			...
			<div class= "row">
				...
				<c:forEach items="${drinks}" var="d">
					<tr>						
							<td class="name"><a href="/olakoa/home/drinks/update/${d.id}">${d.name}<a/></td>
					...
					<c:if test="${!d.posted}">
					<td class="posted">
					<input class="cb" type="checkbox" disabled></td>
					</c:if>
				</tr>			
				</c:forEach>		
			</table>
